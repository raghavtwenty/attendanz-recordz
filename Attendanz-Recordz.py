"""
All Copyrights Reserved by Attandanz Recordz 2021

Designed and Programmed by Raghav, 
Coimbatore Insititute Of Technology,
MSc Artificial Intelligence and Machine Learning [Batch - 2021]

Github : @raghavtwenty

Date Created : 20 December 2020 | Last Updated : 27 December 2021
"""
...
User_Home_Dir = Path.home() / "Attandanz Recordz"
...
def whatsapp():
    webbrowser.open(
        "https://api.whatsapp.com/send/?phone=%2B917904923628&text&app_absent=0"
    )
...
def about_button():
    if about_button:
        ...
        tk.Label(
            about_win, text="Take online meetings attandance FASTER THAN EVER!"
        ).pack()

        # ----- About Window Basic Information -----
        tk.Label(about_win, text="App Name: Attandanz Recordz").place(x=0, y=70)
        ...
        tk.Label(about_win, text="+91 7904923628").place(x=0, y=300)

        # ----- About Window Links -----
        tk.Button(about_win, text="Whatsapp", fg="blue", command=whatsapp).place(
            x=0, y=320
        )

        tk.Button(about_win, text="Website", fg="blue", command=website).place(
            x=0, y=350
        )
...
def save_pdf():
    if save_pdf:
        ...
        pdf.cell(200, 10, txt="Report Generated by Attandanz Recordz", ln=1, align="C")
...
# ----- Main Window -----
root = tk.Tk()
root.title("Attandanz Recordz")
root.geometry("1080x720")
root.resizable(False, False)
tk.Label(
    root, text="Hello 👋, Welcome To Attandanz Recordz !", font=("Arial", 20)
).pack()
...
# ----- Me! -----
tk.Label(
    root, text="© Designed & Programmed by Raghav, CIT MSc AI & ML [Batch - 2021]"
).place(x=350, y=690)
